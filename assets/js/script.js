        ...
        <ul class="nav-links">
            ...
            <li>
                ...
                <ul class="sub-menu">
                    ...
                    <li><a href="https://persephonyyy.github.io/bobagensbobeiras/" target="_blank">SALVAR FICHA</a></li>
                </ul>
            </li>
            <li>
...
window.donosDeAkuma = {
    "Buki Buki no Mi": "???",
    "Hebi Hebi no Mi, Modelo: Kaijū [Original do RPG]": "???",
    "Hemo Hemo no Mi": "???",
    "Hie Hie no Mi": "Valka",
    "Hito Hito no Mi, Modelo: Daibutsu": "Durian Kong",
    "Hito Hito no Mi, Modelo: O Anfitrião [Original do RPG]": "🔒FRUTA PERDIDA PELO MUNDO🔒",
    "Hobi Hobi no Mi": "🔒FRUTA PERDIDA PELO MUNDO🔒",
    "Mera Mera no Mi": "Magnus",
    "Mero Mero no Mi": "🔒FRUTA PERDIDA PELO MUNDO🔒",
    "Modo Modo no Mi": "🔒FRUTA PERDIDA PELO MUNDO🔒",
    "Pika Pika no Mi": "Shantai Figarland",
    "Suji Suji no Mi": "Amon",
